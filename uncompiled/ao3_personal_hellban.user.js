...
(function($) {
    var blacklist = ao3hellban.blacklist,
        ...
        nukeKudos = function() {
            var kudosContainer = $('#feedback #kudos .kudos');
            if (!kudosContainer[0]) return;

            kudosContainer.find('a').each(function() {
                var a = $(this),
        ...
        nukeComments = function() {
            ...
            $('.thread .comment .byline').each(function() {
                var byline = $(this),
                    ...
                    guestName = isGuest && byline.contents()[0] && byline.contents()[0].nodeType == 3 && byline.contents()[0].textContent,
